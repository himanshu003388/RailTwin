                    ...
                    if (active && payload && payload.length) {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div>Expected: <span style={{ color: gradientColor, fontWeight: 700 }}>{data.predicted} min</span></div>
                          <div>Likelihood: <span style={{ color: 'var(--color-text-secondary)' }}>{data.confidence}%</span></div>
                        </div>
                      );
                    }
                    return null;
