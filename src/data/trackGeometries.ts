...
export const TRACK_GEOMETRIES: Record<string, TrackGeometry> = {
  ...
  '12245': {
    ...
    segments: [
      ...
      { from: "KUR", to: "BRAHMPUR", coords: [[85.8492, 20.1903], [84.7967, 19.3137]], distanceKm: 110 },
      { from: "BRAHMPUR", to: "VZM", coords: [[84.7967, 19.3137], [83.4144, 17.6861]], distanceKm: 195 },
      { from: "VZM", to: "VSKP", coords: [[83.4144, 17.6861], [83.2855, 17.7228]], distanceKm: 15 },
      { from: "VSKP", to: "RJY", coords: [[83.2855, 17.7228], [81.8200, 16.5800]], distanceKm: 170 },
      { from: "RJY", to: "VZ", coords: [[81.8200, 16.5800], [80.6172, 16.5173]], distanceKm: 135 },
  ...
  '12625': {
    ...
    segments: [
      ...
      { from: "MAQ", to: "UD", coords: [[74.8452, 12.8694], [74.7429, 13.3368]], distanceKm: 53 },
      { from: "UD", to: "KAWR", coords: [[74.7429, 13.3368], [74.5072, 14.7981]], distanceKm: 167 },
      { from: "KAWR", to: "MAO", coords: [[74.5072, 14.7981], [74.5045, 15.8636]], distanceKm: 120 },
      { from: "MAO", to: "BGM", coords: [[74.5045, 15.8636], [74.5229, 16.5642]], distanceKm: 78 },
      { from: "BGM", to: "MRJ", coords: [[74.5229, 16.5642], [74.6373, 16.8299]], distanceKm: 30 },
